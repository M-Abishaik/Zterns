...
public class Constants {
	...
	public static final String DRIVER_UNAVAILABLE = "No nearest cab found. Please try later.";
	public static final String SEATS_UNAVAILABLE = "The cab with the requested number of seats is not yet available. Please try later or wait for some time.";
