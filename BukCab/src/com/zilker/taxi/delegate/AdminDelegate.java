...
/*
 * Accepts values from the admin UI and passes them to the corresponding DAO's.
 */
public class AdminDelegate {
	...
	public String addCabModel(CabModel cabModel, String userPhone) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in transferring cab model details to DAO.");
	...
	public int getModelID(String modelName, String modelDescription) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in transfering model name and description to DAO.");
			return -1;
		}
	}
	...
	public int getModelByLicencePlate(String licencePlate) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in transfering cab licence plate to DAO.");
			return -1;
		}
	}
	...
	public String updateCabModel(CabModel cabModel, String userPhone, int modelID) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in transferring updated cab model details to DAO.");
			return Constants.FAILURE;
		}
	}
	...
	public String deleteCabModel(int modelID) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in transferring model ID to DAO for deletion.");
			return Constants.FAILURE;
		}
	}
	...
	public ArrayList<CabModelDetail> displayCabModelDetails() {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error in displaying cab model details.");
			return null;
		}
	}
