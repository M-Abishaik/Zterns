...
<%response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
	...
	<div class="vertical-menu">
  		<a class="ridernav" onclick="riderviewbook()" href="${Config.BASE_PATH}locations">Book a ride</a> 
  		<a class="ridernav" onclick="riderviewprofile()" href="${Config.BASE_PATH}riders">Profile</a> 
  		<a class="ridernav" href="${Config.BASE_PATH}rider/rides/completed">My Trips</a> 
        <a class="ridernav" href="${Config.BASE_PATH}logout">Logout</a>
	</div> 
 	<div class="container3 rider">

        <form action="${Config.BASE_PATH}book/ride" id="bookride" method="post">
           ...
           <button class="bottomLogin button button-accent" type="submit" id="login">Book</button>
            <%if(request.getAttribute("errorMessage")!=null){ %>
					<center><p style="color: red; margin-left: -50%; margin-top:3%; font-weight: bold;"><%=request.getAttribute("errorMessage")%></p></center>
					<%}%>
