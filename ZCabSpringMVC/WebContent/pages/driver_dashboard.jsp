...
<header>
	...
	<div class="vertical-menu">
  		<a class="drivernav" onclick="driverdash()">Dashboard</a>
  		<a class="drivernav" onclick="driverviewprofile()" href="${Config.BASE_PATH}dashboard/driver">Profile</a>
        <a class="drivernav" href="${Config.BASE_PATH}dashboard/driver/rides/ongoing">My Trips</a>
        ...
        <div id="driverdash">
	         <div style="position: relative; float: left; margin-top: 8em; margin-left: 2em; width:500px; height:400px;" id="map">
	   		...
	   		<div class="dashboard-container" style="margin-top:7%;">
    			...
    			<button class="button button-accent bookride-cancel" type="submit">Complete Booking</button>
    			</form>		    
    		</div>
        </div>
