...
<body id="bookridepage">
	...
	<div class="vertical-menu">
		<a class="ridernav" style="cursor: pointer" onclick="riderviewbook()"
			...
			href="${Config.BASE_PATH}logout">Logout</a>
	</div>
	<div class="container3 rider">
		<div class="filter-ridertrips">
			<label>Filter by : </label> <a style="cursor: pointer;"
				...
				href="${Config.BASE_PATH}rider/rides/ongoing">Upcoming</a> <a
				style="cursor: pointer;" class="button button-accent completed"
				onclick="completed()"
				href="${Config.BASE_PATH}rider/rides/completed">Completed</a> <a
				style="cursor: pointer;" class="button button-accent cancelled"
				onclick="cancelled()"
				href="${Config.BASE_PATH}rider/rides/cancelled">Cancelled</a>
		</div>
