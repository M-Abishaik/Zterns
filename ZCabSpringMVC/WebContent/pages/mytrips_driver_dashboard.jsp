...
<%if(request.getAttribute("onCancelResponse")!=null){ %>
	...
	<div class="vertical-menu">
  		<a class="drivernav" style="cursor:pointer" href="${Config.BASE_PATH}dashboard/driver">Dashboard</a> 
        <a class="drivernav" style="cursor:pointer">My Trips</a> 
        <a class="drivernav" href="${Config.BASE_PATH}dashboard/driver/profile">Profile</a> 
 	...
 	<div class="container3 driver">
 			<div class="filter-drivertrips">
				...
				<a style="cursor:pointer; text-align: center;" class="button button-accent upcoming" onclick="upcoming()" href="${Config.BASE_PATH}dashboard/driver/rides/ongoing">Ongoing</a> 
                <a style="cursor:pointer; text-align: center;" class="button button-accent completed" onclick="completed()" href="${Config.BASE_PATH}dashboard/driver/rides/completed">Completed</a>
                <a style="cursor:pointer; text-align: center;" class="button button-accent cancelled" onclick="cancelled()" href="${Config.BASE_PATH}dashboard/driver/rides/cancelled">Cancelled</a>				
 			</div>
