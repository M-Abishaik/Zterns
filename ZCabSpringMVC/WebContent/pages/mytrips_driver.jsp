...
<body>
	...
	<div class="vertical-menu">
		<a class="drivernav" href="${Config.BASE_PATH}drivers">Profile</a> <a
			class="drivernav" style="cursor: pointer">My Trips</a> <a
			class="drivernav" href="${Config.BASE_PATH}logout">Logout</a>
	</div>
	...
	<div class="container3 driver">
		<div class="filter-drivertrips">
			<label>Filter by: </label> <a
				...
				href="${Config.BASE_PATH}driver/rides/ongoing">Ongoing</a> <a
				style="cursor: pointer; text-align: center;"
				class="button button-accent completed" onclick="completed()"
				href="${Config.BASE_PATH}driver/rides/completed">Completed</a> <a
				style="cursor: pointer; text-align: center;"
				class="button button-accent cancelled" onclick="cancelled()"
				href="${Config.BASE_PATH}driver/rides/cancelled">Cancelled</a>
		</div>
