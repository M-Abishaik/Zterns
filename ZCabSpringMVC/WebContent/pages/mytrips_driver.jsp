...
<%if(request.getAttribute("onCancelResponse")!=null){ %>
	...
	<div class="vertical-menu">
  		<a class="drivernav" href="${Config.BASE_PATH}drivers">Profile</a> 
 	...
 	<div class="container3 driver">
 			<div class="filter-drivertrips">
				...
				<a style="cursor:pointer; text-align: center;" class="button button-accent upcoming" onclick="upcoming()" href="${Config.BASE_PATH}driver/rides/ongoing">Ongoing</a> 
                <a style="cursor:pointer; text-align: center;" class="button button-accent completed" onclick="completed()" href="${Config.BASE_PATH}driver/rides/completed">Completed</a>
                <a style="cursor:pointer; text-align: center;" class="button button-accent cancelled" onclick="cancelled()" href="${Config.BASE_PATH}driver/rides/cancelled">Cancelled</a>				
 			</div>
