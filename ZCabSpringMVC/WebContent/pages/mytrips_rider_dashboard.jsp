...
<%if(request.getAttribute("onCancelResponse")!=null){ %>
	...
	<div class="vertical-menu">
  		<a class="ridernav" style="cursor:pointer" href="${Config.BASE_PATH}dashboard/rider">Dashboard</a> 
        <a class="ridernav" style="cursor:pointer">My Trips</a> 
        <a class="ridernav" href="${Config.BASE_PATH}dashboard/rider/profile">Profile</a> 
        <a class="ridernav" href="${Config.BASE_PATH}logout">Logout</a>
 </div> 
 	<div class="container3 rider">
 			<div class="filter-ridertrips">
                <label>Filter by : </label>
                <a style="cursor:pointer;" class="button button-accent upcoming" onclick="upcoming()" href="${Config.BASE_PATH}dashboard/rider/rides/ongoing">Upcoming</a> 
                <a style="cursor:pointer;" class="button button-accent completed" onclick="completed()" href="${Config.BASE_PATH}dashboard/rider/rides/completed">Completed</a>
                <a style="cursor:pointer;" class="button button-accent cancelled" onclick="cancelled()" href="${Config.BASE_PATH}dashboard/rider/rides/cancelled">Cancelled</a>
 			</div>
