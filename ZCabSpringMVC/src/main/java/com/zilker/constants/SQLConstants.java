...
public class SQLConstants {
	...
	public static final String DISPLAY_CUSTOMER_COMPLETED_RATED_RIDES = "SELECT CAB_RIDE_DETAIL.CAB_RIDE_ID, DRIVER_ID, START_TIME, SOURCE_ADDRESS_ID, DESTINATION_ADDRESS_ID, CAB_ID, PRICE, RATING FROM CAB_RIDE_DETAIL, RATING WHERE CAB_RIDE_DETAIL.CAB_RIDE_ID=RATING.CAB_RIDE_ID AND USER_ID=? AND STATUS_ID=?";

	public static final String DISPLAY_DRIVER_COMPLETED_RATED_RIDES = "SELECT CAB_RIDE_DETAIL.CAB_RIDE_ID, USER_ID, START_TIME, SOURCE_ADDRESS_ID, DESTINATION_ADDRESS_ID, CAB_ID, PRICE, RATING FROM CAB_RIDE_DETAIL, RATING WHERE CAB_RIDE_DETAIL.CAB_RIDE_ID=RATING.CAB_RIDE_ID AND DRIVER_ID=? AND STATUS_ID=?";
	...
	public static final String GET_ONGOING_RIDE_DETAILS = "SELECT CAB_RIDE_ID, DRIVER_ID, START_TIME, SOURCE_ADDRESS_ID, DESTINATION_ADDRESS_ID, CAB_ID, PRICE FROM CAB_RIDE_DETAIL WHERE CAB_RIDE_ID=?";
