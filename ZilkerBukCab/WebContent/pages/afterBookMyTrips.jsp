...
<%if(request.getAttribute("onCancelResponse")!=null){ %>
	...
	<div class="vertical-menu">
        <button class="button button-dark">My Trips</button>
        <a class="logout" href="${Config.BASE_PATH}LogoutServlet">Logout</a>
	</div> 
 	<div class="container3 rider">
 			<div class="filter-ridertrips" style="margin-top:25%;">
                <label>Filter by : </label>
                <a style="cursor:pointer;" class="button button-accent upcoming" onclick="upcoming()" href="${Config.BASE_PATH}AfterBookOnGoingRidesServlet">Ongoing</a> 
                <a style="cursor:pointer;" class="button button-accent completed" onclick="completed()" href="${Config.BASE_PATH}AfterBookCompletedRidesServlet">Completed</a>
                <a style="cursor:pointer;" class="button button-accent cancelled" onclick="cancelled()" href="${Config.BASE_PATH}AfterBookCancelledRidesServlet">Cancelled</a>
 			</div>
