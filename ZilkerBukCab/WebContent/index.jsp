	...
	<section class="home-hero">
		<div class="container" class="main">
			...
			<div class="container2">
        		...
        		<form action="${Config.BASE_PATH}LoginServlet" id="login" onsubmit="return validateLogin()" method="post">
            		<div class="login">
	        	...
	        	<form action="${Config.BASE_PATH}RegistrationServlet" id="signup" onsubmit="return validateRegistration()" method="post">
	            	<div class="signup">
