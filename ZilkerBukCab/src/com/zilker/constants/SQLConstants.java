...
public class SQLConstants {
	...
	public static final String DISPLAY_BOOKING_DETAILS = "SELECT CAB_RIDE_ID, DRIVER_ID, START_TIME, SOURCE_ADDRESS_ID, DESTINATION_ADDRESS_ID, CAB_ID, PRICE FROM CAB_RIDE_DETAIL WHERE USER_ID=? AND STATUS_ID=?";
