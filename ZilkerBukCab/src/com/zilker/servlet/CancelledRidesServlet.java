...
/**
 * Servlet implementation class CancelledRidesServlet
 */
@WebServlet("/CancelledRidesServlet")
public class CancelledRidesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CancelledRidesServlet() {
        super();
